             ...
             var foodList = ArrayList<Food>().also {
                 ...
                 it.add(
                     Food(
                       ...
                       context.  getString(R.string._Amiras_iamges),2.0f,2.0f,R.drawable.ic_bullet,context.getString(R.string._amiras))
                 )
                 it.add(
                     Food(
                         1, context.getString(R.string._Surbhi_Restaurant), context.getString(R.string._Surbhi_Restaurant_desc), context.getString(
                             R.string._Sandwich_iamges),2.0f,2.0f,R.drawable.ic_bullet,context.getString(R.string._Surbhi)))
                 ...
                 it.add(
                     Food(
                         ...
                         context.getString(R.string._Burger_images),2.0f,2.0f,R.drawable.ic_bullet,context.getString(R.string._Rajwadi))
                 ...
                 it.add(
                     Food(
                         ...
                         context. getString(R.string._Dosha_images),2.0f,2.0f,R.drawable.ic_bullet,context.getString(R.string._Patel))

                 )
                 it.add(
                     Food(
                         1, context.getString(R.string._Muridher_Restaurant), context.getString(R.string._Muridher_Restaurant_desc),
                         context.getString(R.string._Powbhaji_images),2.0f,2.0f,R.drawable.ic_bullet,context.getString(R.string._Murlidhar))
...
//        fun getMessageData(context: Context):ArrayList<Message> {
//            var messagList = ArrayList<Message>().also {
//
//                it.add(
//                    Message(1, "hello", "10-08-2021 05:12 pm", "Hi", "10-08-2021 05:12 pm")
//                )
//
//            }
//            return messagList
