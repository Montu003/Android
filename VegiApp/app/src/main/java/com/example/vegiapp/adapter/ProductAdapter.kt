...
import com.example.vegiapp.activity.ProductDetailActivity
import com.example.vegiapp.api.Const
import com.example.vegiapp.databinding.ItemSubcategoryBinding
   ...
   inner class SubCategoryViewHolder(itemView: View) : ViewHolder(itemView){
       ...
       fun setmodel(position: Int){
          ...
          Glide.with(itemView)
           ...
           // activity move ProductDetailActivity
           binding.ivImage.setOnClickListener {
               val intent = Intent(binding.ivImage.context,ProductDetailActivity::class.java)
