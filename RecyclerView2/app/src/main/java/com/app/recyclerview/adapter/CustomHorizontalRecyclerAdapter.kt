...
import com.app.recyclerview.databinding.ListHorizontalItemLayoutBinding
import com.app.recyclerview.model.moviedata

class CustomHorizontalRecyclerAdapter(var context: Context, var movieList: MutableList<moviedata>) :
