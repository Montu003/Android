package com.app.androidstoragepermission
...
import com.example.storage_permission.R
...
class MainActivity : AppCompatActivity() {
    ...
    private fun askStoragePermission() {
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            // true
            Toast.makeText(applicationContext, "Permission already allowed", Toast.LENGTH_SHORT)
                .show()
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQ_STORAGE) {
            ...
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                // allowed
                Toast.makeText(applicationContext, "User allowed Permission", Toast.LENGTH_SHORT)
                    .show()
            } else {
                // deny
                Toast.makeText(applicationContext, "User denied Permission", Toast.LENGTH_SHORT)
                    .show()
            }
        }
    }
