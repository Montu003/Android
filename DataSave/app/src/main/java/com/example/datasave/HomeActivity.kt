...
import com.example.datasave.databinding.ActivityHomeBinding
import com.example.datasave.databinding.DialogLayoutBinding
                    ...
                    if (name.isEmpty()) {
                        ...
                        AlertDialog.Builder(this@HomeActivity)
                            ...
                            .setPositiveButton("Yes", DialogInterface.OnClickListener { dialog, i ->
                                ApiClient.init().updateUserData(3, user.id, name, contact)
                                    .enqueue(object :
                                        Callback<Student> {
                                        override fun onResponse(
                                            ...
                                            if (response.isSuccessful) {
                                                response.body()?.let {
                                                    var mUser =
                                                        user.copy(name = name, contact = contact)
