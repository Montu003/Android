...
import com.example.datasave.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun loginUser(email: String,password:String) {
        ...
        ApiClient.init().loginAccount(6,email,password).enqueue(object:
            Callback<RegisterCallbackResponse> {
