...
class MessageAdepter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is SentViewHolder) {
            ...
            holder.bind.tvSendtime.text = convertDate(currentmessage.time.toString(),"dd MMM yyyy hh:mm aa")

        } else if (holder is ReciverMessage) {
            holder.bind.tvRecivermessage.text = currentmessage.message
            holder.bind.tvRecvetime.text = convertDate(currentmessage.time.toString(),"dd MMM yyyy hh:mm aa")
        }
    }
